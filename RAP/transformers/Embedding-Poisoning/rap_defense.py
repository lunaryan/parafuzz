...
def rap_defense(clean_train_data_path, trigger_words_list, trigger_inds_list, ori_norms_list, protect_label,
    ...
    train_text_list, train_label_list = read_tsv_data(clean_train_data_path, protect_label, 2500)
...
def load_model_wth_trigger(trigger_words_list, device):
...
def defend_stylebkd(args):
    args.save_model_path = 'RAP_defended'
    seed = args.seed
    trigger_words_list = args.trigger_words.split('_')
    model, parallel_model, tokenizer, trigger_inds_list, ori_norms_list = load_model_wth_trigger(trigger_words_list,
    ...
    #args.data_path = 'sentiment/imdb_clean_train/new_dev.tsv'
    args.data_path = '/data3/share/nlp_backdoor_datasets/sentiment/imdb/dev.tsv'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trigger_words', type=str, default='mb', help='RAP trigger words, usually one rare word')
