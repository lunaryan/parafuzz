...
def style_predict(texts, tokenizer, model, batch_size=1):
    all_preds = []
...
def evaluate_seed(seed_prompt='sound like a young girl'):
    ...
    reph_clean = rephrase_victim(clean_test_data, seed_prompt, 'clean')
    reph_poison = rephrase_victim(poison_test_data, seed_prompt, 'poison')
...
if __name__ == '__main__':
    ...
    reph_best = 'Sound like a squeaking valley girl' #rebuttal
    evaluate_seed(reph_best)
